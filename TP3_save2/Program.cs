...
namespace TP3
{
    internal class Program
    {
        class Salaire
        {
            ...
            private static int Nbr_Employer = 2;
            public Salaire(String NomEmployer,String Sexe, double SalaireEmployer, DateTime Annee_de_recrutement, String Poste)
            {
                ...
                { 
                    throw new Exception("Erreur Nombre D'employer possible atteint");
                }
            }
        ...
        static void Main(string[] args)
        {
           ...
           /* Console.WriteLine($"{date.Year}");*/
            ...
            Console.WriteLine($"Nombre d'employer restant : {Employer[0].get_Nbr_Employer()}");
        }
    }
}
