...
namespace TP3
{
    internal class Program
    {
        class Salaire
        {
            ...
            private static String NomAdmin = "NTP";
            ...
            public void  CalculSalaire()
            {
                ...
                this.SalaireEmployer = Salaire_Employer_annee;
        ...
        static void Main(string[] args)
        {
            ...
            Console.Clear();
                ...
                for (int i = 0; i < n; i++)
                {
                    ...
                    Console.WriteLine("Choississez votre poste: 1.Informaticien 2.Comptable 3.Secretaire");
